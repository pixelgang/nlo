package com.ecomexpert.nlo.ui.item.favourite;
...
import com.ecomexpert.nlo.databinding.FragmentFavouriteListBinding;
import com.ecomexpert.nlo.ui.common.DataBoundListAdapter;
import com.ecomexpert.nlo.ui.common.PSFragment;
import com.ecomexpert.nlo.ui.item.adapter.ItemVerticalListAdapter;
...
//            }
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent, item -> navigationController.navigateToItemDetailActivity(getActivity(), item.id, item.title), this);
