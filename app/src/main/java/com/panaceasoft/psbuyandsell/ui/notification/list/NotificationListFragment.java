package com.ecomexpert.nlo.ui.notification.list;
...
import com.ecomexpert.nlo.databinding.FragmentNotificationListBinding;
import com.ecomexpert.nlo.ui.common.DataBoundListAdapter;
import com.ecomexpert.nlo.ui.common.PSFragment;
import com.ecomexpert.nlo.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.ecomexpert.nlo.viewobject.Noti> notificationList) {
